...
INSERT INTO "new_Bookmark" ("active", "createdAt", "id", "imageUrl", "mediaId", "overview", "title", "typeMediaId", "userId", "voteAverage", "yearReleased") SELECT "active", "createdAt", "id", "imageUrl", "mediaId", "overview", "title", "typeMediaId", "userId", "voteAverage", "yearReleased" FROM "Bookmark";
DROP TABLE "Bookmark";
