...
import ImageWithLoader from "@/components/SectionMedia/ViewMedia/ImageWIthLoader";
import { WrapperComponent } from "@/components/SectionMedia/ViewMedia/ViewWrapper";
...
export default ViewServerBookmark;
