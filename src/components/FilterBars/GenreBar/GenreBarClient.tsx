...
const GenreBarClient = ({ genres }: Props) => {
  ...
  return (
    <>
      <input
        className="w-full pr-10 pl-2 py-3 rounded-lg bg-semi-dark-blue border border-grayish-blue text-white-smoke outline-none focus:border-white-dust hover:cursor-pointer hover:opacity-70 transition-opacity"
        type="button"
